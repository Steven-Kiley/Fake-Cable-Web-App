...
<%@ page import = "accounts.Customer, java.util.ArrayList, javax.servlet.http.*, javax.servlet.*, services.*, java.text.DecimalFormat, java.util.Date" %>
<div id="header"><h1>
Wide Cast
...
<h1><strong>Welcome to Wide Cast!</strong></h1><hr><h2>Here are the details of your account!<h2><br>
